...
func (mw *instrumentingMiddleware) CreateDMSForm(ctx context.Context, dmsForm dms.DmsCreationForm) (_ string, d dms.DMS, err error) {
	defer func(begin time.Time) {
...
func (mw *instrumentingMiddleware) UpdateDMSStatus(ctx context.Context, dIn dms.DMS, id int) (dOut dms.DMS, err error) {
	defer func(begin time.Time) {
